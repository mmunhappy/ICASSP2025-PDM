...
def train(epoch):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        feat1, out1, loss_ort, feats, loss_dp, outs = net(input1, input2)
        ...
        loss = loss_id + loss_tri + loss_cpm * 0.5 + loss_ort + loss_dp * 0.5 + loss_dcs
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
        ...
        if batch_idx % 50 == 0:
            print('Epoch: [{}][{}/{}] '
                ...
                epoch, batch_idx, len(trainloader), loss_dcs, loss_dp,
