    ...
    for i in range(0, 3803, 30):
        ...
        for row in range(fig_per_num):
            ...
            for col in range(1 + 1, rank + 1 + 1):
                ...
                axs[col].axis('off')
        if not os.path.isdir('./save_ranking/' + str(begin) + '_' + str(end)):
            os.makedirs('./save_ranking/' + str(begin) + '_' + str(end))

        output_dir = './save_ranking/' + str(begin) + '_' + str(end) + '/tmp' + str(trial) + '.png'
